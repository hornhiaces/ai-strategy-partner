...
const Hero = () => {
  return <section className="flex items-center px-6 pt-24 pb-12 md:pt-32 md:pb-16 bg-gradient-subtle">
      <div className="max-w-6xl mx-auto w-full">
        <div className="max-w-2xl">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-lg mb-8 leading-relaxed animate-hero-load animate-hero-load-delay-3">I help organizations move AI and Generative AI from strategy to working systems, with a focus on regulated industries like healthcare and financial services.
        </p>
